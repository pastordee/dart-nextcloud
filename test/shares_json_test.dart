...
void main() {
  group('Share JSON parsing', () {
    test('should parse the actual JSON response from your error', () {
      const jsonResponse = '''{"ocs":{"meta":{"status":"ok","statuscode":200,"message":"OK"},"data":{"id":"347","share_type":3,"uid_owner":"admin","displayname_owner":"admin","permissions":17,"can_edit":true,"can_delete":true,"stime":1755053653,"parent":null,"expiration":null,"token":"2y4PiHbztDFweFL","uid_file_owner":"admin","note":"","label":"","displayname_file_owner":"admin","path":"/Users/Fsq01ZeMcq/profile_pics/1755053644605_avatar.jpg","item_type":"file","item_permissions":27,"is-mount-root":false,"mount-type":"","mimetype":"image/jpeg","has_preview":true,"storage_id":"home::admin","storage":1,"item_source":19064,"file_source":19064,"file_parent":18987,"file_target":"/1755053644605_avatar.jpg","item_size":4325675,"item_mtime":1755053652,"share_with":null,"share_with_displayname":"(Shared link)","password":null,"send_password_by_talk":false,"url":"https://files.prayercircle.co.uk/s/2y4PiHbztDFweFL","mail_send":1,"hide_download":0,"attributes":null}}}''';

      final share = shareFromResponse(jsonResponse);

      expect(share.id, equals(347));
      expect(share.shareType, equals(3));
      expect(share.uidOwner, equals('admin'));
      expect(share.displaynameOwner, equals('admin'));
      expect(share.token, equals('2y4PiHbztDFweFL'));
      expect(share.path, equals('/Users/Fsq01ZeMcq/profile_pics/1755053644605_avatar.jpg'));
      expect(share.itemType, equals('file'));
      expect(share.mimeType, equals('image/jpeg'));
      expect(share.url, equals('https://files.prayercircle.co.uk/s/2y4PiHbztDFweFL'));
      expect(share.fileTarget, equals('/1755053644605_avatar.jpg'));
      
      // Test null expiration handling
      expect(share.expiration.year, equals(2099)); // Should be our default far future date
    });

    test('should parse JSON with expiration date', () {
      const jsonResponseWithExpiration = '''{"ocs":{"meta":{"status":"ok","statuscode":200,"message":"OK"},"data":{"id":"123","share_type":3,"uid_owner":"admin","displayname_owner":"admin","permissions":17,"stime":1755053653,"parent":"","expiration":"2024-12-31T23:59:59Z","token":"testtoken","uid_file_owner":"admin","note":"","label":"","displayname_file_owner":"admin","path":"/test.jpg","item_type":"file","mimetype":"image/jpeg","storage_id":"home::admin","storage":1,"item_source":123,"file_source":123,"file_parent":0,"file_target":"/test.jpg","share_with":"","share_with_displayname":"(Shared link)","password":"","url":"https://example.com/s/testtoken","mail_send":0,"hide_download":0}}}''';

      final share = shareFromResponse(jsonResponseWithExpiration);
    ...
    test('should fallback to XML parsing for XML responses', () {
...
<ocs>
  ...
  <data>
    ...
    test('should parse JSON list response for multiple shares', () {
      const jsonListResponse = '''{"ocs":{"meta":{"status":"ok","statuscode":200,"message":"OK"},"data":[{"id":"123","share_type":3,"uid_owner":"admin","displayname_owner":"admin","permissions":17,"stime":1755053653,"parent":"","expiration":null,"token":"token1","uid_file_owner":"admin","note":"","label":"","displayname_file_owner":"admin","path":"/test1.jpg","item_type":"file","mimetype":"image/jpeg","storage_id":"home::admin","storage":1,"item_source":123,"file_source":123,"file_parent":0,"file_target":"/test1.jpg","share_with":"","share_with_displayname":"(Shared link)","password":"","url":"https://example.com/s/token1","mail_send":0,"hide_download":0},{"id":"124","share_type":3,"uid_owner":"admin","displayname_owner":"admin","permissions":17,"stime":1755053654,"parent":"","expiration":null,"token":"token2","uid_file_owner":"admin","note":"","label":"","displayname_file_owner":"admin","path":"/test2.jpg","item_type":"file","mimetype":"image/jpeg","storage_id":"home::admin","storage":1,"item_source":124,"file_source":124,"file_parent":0,"file_target":"/test2.jpg","share_with":"","share_with_displayname":"(Shared link)","password":"","url":"https://example.com/s/token2","mail_send":0,"hide_download":0}]}}''';

      final shares = sharesFromResponse(jsonListResponse);
